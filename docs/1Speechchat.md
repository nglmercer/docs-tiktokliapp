---
sidebar_label: 'Texto a voz TTS'
sidebar_position: 1
---
# Speechchat TTS
### Voces disponibles
Existe dos proovedores de voz disponibles:
1. Streamelements API
2. Local TTS
Puedes elegir cual quieres usar.

## Local TTS
Esta es una API proporcionada por tu sistema operativo.
- tiene soporte multidioma.
- voces disponibles son muy limitadas.
- no falla porque es local.
- tiene mas opciones de customizacion.
## Streamelements API
Este bot de voz a sido proporcionado por Steamelements.
- limite maximo de mensajes.
- puede fallar si el servidor no esta disponible.
- puede ser un problema de conexion.
